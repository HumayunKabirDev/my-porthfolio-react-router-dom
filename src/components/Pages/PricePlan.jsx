      ...
      <Container>
        ...
        <div className="md:ml-[420px] px-5 md:w-2/3">
          <div className="md:flex gap-x-5 w-full px-5 sm:px-0 ">
            <div data-aos="fade-right" data-aos-duration="800" data-aos-easing="ease-in-sine" className="bg-primaryC w-full  md-px-0 p-10 text-center text-white rounded-[10px]">
            ...
            <div data-aos="fade-left" data-aos-duration="800" data-aos-easing="ease-in-sine" className="bg-primaryC w-full mt-4 sm:mt-0 md-px-0 p-10 text-center text-white rounded-[10px]">
              <h4 className="text-[20px] font-bold mb-3">Hourly Payment</h4>
              <h3>
                ${" "}
                <span className="text-[40px] text-white mt-5 font-bold">
