    ...
    <div className="bg-bgColor py-10 w-full px-5 md:px-0 ">
      <Container>
        <Flex className="justify-between grid grid-cols-1 gap-y-5 sm:gap-x-5 px-5 lg:grid-cols-3 sm:pl-[420px] sm:-mt-[140px] relative">
          {/* Card Start */}
          <div className="bg-primaryC p-5 mx-auto w-full  sm:w-full rounded-[10px] text-white" style={{ boxShadow: '0px  3px 5px rgba(0, 255, 0, 0.5)' }}>
            ...
            <p className="text-[18px] text-center font-medium mt-5">Completed projects</p>
          </div>

          <div className="bg-primaryC p-5 mx-auto w-full  sm:w-full rounded-[10px] text-white px-5" style={{ boxShadow: '0px  3px 5px rgba(0, 255, 0, 0.5)' }}>
            <h3 className="text-[45px] font-bold text-center py-5 border-b-2 border-bgColor w-full">
              <CountUp start={0} end={50} duration={2.75}></CountUp> +
            </h3>
            <p className="text-[18px] text-center font-medium mt-5">Happy customers</p>
          </div>
          ...
          <div className="bg-primaryC p-5 mx-auto w-full  sm:w-full rounded-[10px] text-white" style={{ boxShadow: '0px  3px 5px rgba(0, 255, 0, 0.5)' }}>
            ...
            <p className="text-[18px] text-center font-medium mt-5">Honors and Awards</p>
          </div>
          {/* Card Start */}
        </Flex>
        {/* My Story Start */}
        <div className="flex items-center justify-between md:pl-[420px] py-7 px-5 sm:w-full">
        ...
        <div className="md:w-2/3 px-5 md:px-3">
            <div className="sm:ml-[410px] relative sm:mx-0 w-full rounded-[10px] bg-primaryC p-10 text-white " style={{ boxShadow: '0px  3px 5px rgba(0, 255, 0, 0.5)' }}>
